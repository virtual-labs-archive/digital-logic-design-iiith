...
public class XnorGate3 extends Element {
     ...
     */
    XnorGate3(int id, String type, int inpId, int outId, Point coord) {
        elementID = id;
        elementType = type;
    ...
    public void draw(Graphics g, Point p){
        ...
        QuadCurve2D q4 = new QuadCurve2D.Float(p.x-37, p.y-55, p.x-7, p.y, p.x-37, p.y+55);
        ...
        inputList.elementAt(0).draw(g, new Point(p.x-27, p.y-40));
        inputList.elementAt(1).draw(g, new Point(p.x-27, p.y));
        inputList.elementAt(2).draw(g, new Point(p.x-27, p.y+40));
