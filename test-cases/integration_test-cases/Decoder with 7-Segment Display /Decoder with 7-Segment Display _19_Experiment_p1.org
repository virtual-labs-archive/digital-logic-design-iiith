...
* Test Steps
  ...
  8. Select connect option and click on the elements
...
* Expected result
  ...
  7. If the selected elementsare defined then the elements should get connected else an error message should be displayed on the screen
