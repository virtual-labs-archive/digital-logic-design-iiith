...
* Test Steps
  ...
  7. Now click on Simulate button and select 'Out' option
...
* Expected result
  ...
  7. Click on the connecting nodes which appears in red colour on the screen , and the probe values should be erased from the screen
