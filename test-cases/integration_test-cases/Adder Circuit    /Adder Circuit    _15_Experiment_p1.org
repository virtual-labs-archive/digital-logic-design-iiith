...
* Objective
  - To perform the Simulation of the Adder Circuit experiment
...
* Test Steps
  ...
  6. Select the adder either full-bit adder or 4bit-adder from the dropdown list displayed and click on 'load it' button
