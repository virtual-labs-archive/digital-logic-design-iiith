...
<!-- The lab Header contains the logo and the name of the lab,
	...
	page of your lab (h1 tag is preferred while writing your 
			lab name)-->
	<a href="<?php echo esc_url( $lab_url )?>"> <?php echo $labheaderheading?></a>	
	</div>
	...
	<div class="breadcrumb" id="experiment-article-breadcrumb"><a href="<?php echo esc_url( $vlab_url )?>">Home</a><a></a> &gt; <a href="<?php echo $lab_url?>">Digital Logic Design Lab</a>    </div>
  ...
  footer-->
   <footer id="lab-footer" class="footer">
	...
	<a href="http://virtual-labs.ac.in/nmeict/">Sponsered by MHRD (NME-ICT) </a> | <a href="http://virtual-labs.ac.in/licensing/" target="_blank"> Licensing Terms </a> | <a href="http://virtual-labs.ac.in/feedback/?lab=cse15/" target="_blank"> Feedback </a>
  </footer>
